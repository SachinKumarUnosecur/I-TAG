  ...
  return (
    <header className="top-strip">
        ...
        <div className="top-strip-brand">
          <div className="top-strip-logo">
            <svg viewBox="0 0 24 24" width="16" height="16" fill="none">
              <path
                d="M12 2l8 3.5v6.2c0 5.1-3.4 9.7-8 10.8-4.6-1.1-8-5.7-8-10.8V5.5L12 2z"
                fill="#00B44A"
              />
              <text
                x="12"
      ...
      <div className="top-strip-right">
        ...
        <div className="top-strip-avatar" title="Tom Walker">
          TW
        </div>
      </div>
    </header>
...
function AnimatedRoutes({ location }) {
  ...
  useEffect(() => {
    const routeChanged =
      ...
      `${displayedLocation.pathname}${displayedLocation.search}`;
    ...
    const exitTimer = window.setTimeout(() => setPhase("exiting"), 0);
  ...
  return (
    <>
      <div
        className={`route-progress ${phase !== "idle" ? "is-active" : ""}`}
        aria-hidden="true"
      >
        <span />
      </div>
      <div className={`route-stage is-${phase}`}>
        <Routes location={displayedLocation}>
          ...
          <Route
            path="/exposure-map/:identityId"
            element={<ExposureIdentity />}
          />
